...
- Goal shifts are model-led: when a turn is marked non-continuation, runtime clears active scoped targets and carried evidence before the next research loop.
